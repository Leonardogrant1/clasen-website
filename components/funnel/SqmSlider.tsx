...
type SqmSlug = "<50" | "50-80" | "80-120" | "120-200" | "200+"

const TIERS: Array<{ slug: SqmSlug; label: string }> = [
  { slug: "<50",     label: "Unter 50 m²" },
  { slug: "50-80",   label: "50 – 80 m²" },
  { slug: "80-120",  label: "80 – 120 m²" },
  { slug: "120-200", label: "120 – 200 m²" },
  { slug: "200+",    label: "Über 200 m²" },
]

type SqmSliderProps = {
  onComplete: (sqm: SqmSlug) => void
}

export default function SqmSlider({ onComplete }: SqmSliderProps) {
